...
</style><div class="dv-wrap"><div class="selector-callout"><details class="callout"><summary>Selecionar hábitos e meses</summary><div class="meta">Escolha os hábitos e meses que deseja visualizar. Pressione Aplicar para gerar os heatmaps.</div><div style="display: flex; gap: 12px; align-items: flex-start; margin-top: 8px;"><div style="flex: 1 1 0%;"><div class="habit-grid"><div class="habit-item"><input type="checkbox" id="chk-o2103i"><label for="chk-o2103i">Água</label></div><div class="habit-item"><input type="checkbox" id="chk-ygh0pf"><label for="chk-ygh0pf">Alimentação</label></div><div class="habit-item"><input type="checkbox" id="chk-v9k1yi"><label for="chk-v9k1yi">dayRating</label></div><div class="habit-item"><input type="checkbox" id="chk-l778jg"><label for="chk-l778jg">Exercício</label></div><div class="habit-item"><input type="checkbox" id="chk-qd1v1o"><label for="chk-qd1v1o">Gases</label></div><div class="habit-item"><input type="checkbox" id="chk-q3jvoo"><label for="chk-q3jvoo">Gastos</label></div><div class="habit-item"><input type="checkbox" id="chk-ccjfgn"><label for="chk-ccjfgn">gdfd</label></div><div class="habit-item"><input type="checkbox" id="chk-zaurv0"><label for="chk-zaurv0">Hidratação</label></div><div class="habit-item"><input type="checkbox" id="chk-s115tc"><label for="chk-s115tc">Leitura</label></div><div class="habit-item"><input type="checkbox" id="chk-alp7u2"><label for="chk-alp7u2">Meditação</label></div><div class="habit-item"><input type="checkbox" id="chk-3toare"><label for="chk-3toare">ooooooooi</label></div><div class="habit-item"><input type="checkbox" id="chk-aln2vk"><label for="chk-aln2vk">peidar</label></div><div class="habit-item"><input type="checkbox" id="chk-ehpz23"><label for="chk-ehpz23">Pinochio</label></div><div class="habit-item"><input type="checkbox" id="chk-frgjxz"><label for="chk-frgjxz">QAsono</label></div><div class="habit-item"><input type="checkbox" id="chk-nf5ce5"><label for="chk-nf5ce5">qualquer</label></div><div class="habit-item"><input type="checkbox" id="chk-yftbwd"><label for="chk-yftbwd">rfgfgsd</label></div><div class="habit-item"><input type="checkbox" id="chk-mgo40l"><label for="chk-mgo40l">salve</label></div><div class="habit-item"><input type="checkbox" id="chk-xc5stb"><label for="chk-xc5stb">Socialização</label></div><div class="habit-item"><input type="checkbox" id="chk-pcvuqt"><label for="chk-pcvuqt">Sono</label></div><div class="habit-item"><input type="checkbox" id="chk-swkkjr"><label for="chk-swkkjr">werer</label></div><div class="habit-item"><input type="checkbox" id="chk-oqgb61"><label for="chk-oqgb61">what</label></div></div></div><div style="min-width: 220px; display: flex; flex-direction: column; gap: 10px;"><div class="small">Filtrar meses</div><div class="month-filter"><div class="month-item"><input type="checkbox" id="mo-0-kh59"><label for="mo-0-kh59">Jan</label></div><div class="month-item"><input type="checkbox" id="mo-1-pvtx"><label for="mo-1-pvtx">Fev</label></div><div class="month-item"><input type="checkbox" id="mo-2-d7nc"><label for="mo-2-d7nc">Mar</label></div><div class="month-item"><input type="checkbox" id="mo-3-z4c7"><label for="mo-3-z4c7">Abr</label></div><div class="month-item"><input type="checkbox" id="mo-4-sqxn"><label for="mo-4-sqxn">Mai</label></div><div class="month-item"><input type="checkbox" id="mo-5-9qbr"><label for="mo-5-9qbr">Jun</label></div><div class="month-item"><input type="checkbox" id="mo-6-1kfe"><label for="mo-6-1kfe">Jul</label></div><div class="month-item"><input type="checkbox" id="mo-7-3q86"><label for="mo-7-3q86">Ago</label></div><div class="month-item"><input type="checkbox" id="mo-8-dopq"><label for="mo-8-dopq">Set</label></div><div class="month-item"><input type="checkbox" id="mo-9-prd3"><label for="mo-9-prd3">Out</label></div><div class="month-item"><input type="checkbox" id="mo-10-t0o7"><label for="mo-10-t0o7">Nov</label></div><div class="month-item"><input type="checkbox" id="mo-11-tr55"><label for="mo-11-tr55">Dez</label></div></div><div class="controls"><button class="btn">Aplicar seleção</button></div></div></div></details></div><div class="render-area"></div></div>
